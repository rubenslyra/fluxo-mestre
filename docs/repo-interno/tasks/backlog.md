...
| TASK-2026-05-28-001 | ANA-2026-05-28-001 | Alta       | Aberta    | Criar testes automatizados para `src/components/flowchart/codeBlueprints.ts`.   | Casos da matriz passam em teste automatizado para combinacoes principais de linguagem, blueprint e fixtures de fluxograma.                                               |
